...
public class KSSHexToFrames{
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String hextarget = input.nextLine();
            hextarget = hextarget.toLowerCase();
            ...
            while (!(hex.equals(hextarget)) && (frames < 65535)){
            ...
            if (frames < 65535)
                ...
                System.out.println("Frame could not be found. Make sure the values are typed correctly.");
